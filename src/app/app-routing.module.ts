import { Perfil_publicoComponent } from './perfil_publico/perfil_publico.component';
...
{
  path: 'perfil_publico',
  component: Perfil_publicoComponent,
  loadChildren: () => import('./perfil_publico/perfil_publico.module').then( m => m.Perfil_publicoModule )
},
{
  path: '**',
  component: HomeComponent
